...
import 'edit_productfrom_store_model.dart';
export 'edit_productfrom_store_model.dart';

class EditProductfromStoreWidget extends StatefulWidget {
  const EditProductfromStoreWidget({Key? key}) : super(key: key);

  @override
  _EditProductfromStoreWidgetState createState() =>
      _EditProductfromStoreWidgetState();
}

class _EditProductfromStoreWidgetState
    extends State<EditProductfromStoreWidget> {
  late EditProductfromStoreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProductfromStoreModel());
