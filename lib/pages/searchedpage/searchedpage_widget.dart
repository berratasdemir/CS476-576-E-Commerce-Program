...
import 'searchedpage_model.dart';
export 'searchedpage_model.dart';

class SearchedpageWidget extends StatefulWidget {
  const SearchedpageWidget({
    Key? key,
    this.search,
    this.searchresults,
  }) : super(key: key);
  ...
  @override
  _SearchedpageWidgetState createState() => _SearchedpageWidgetState();
}

class _SearchedpageWidgetState extends State<SearchedpageWidget> {
  late SearchedpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchedpageModel());
