...
import 'changemail_model.dart';
export 'changemail_model.dart';

class ChangemailWidget extends StatefulWidget {
  const ChangemailWidget({Key? key}) : super(key: key);

  @override
  _ChangemailWidgetState createState() => _ChangemailWidgetState();
}
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Your new  e-mail address',
                        labelStyle:
                ...
                Padding(
                  ...
                  child: Text(
                    'To confirm please enter your current email and password. Then click the button',
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Your current e-mail address',
                        labelStyle:
                            FlutterFlowTheme.of(context).bodySmall.override(
                                  fontFamily: 'Outfit',
                                  color: Color(0xFF57636C),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: !_model.currentpwVisibility,
                      decoration: InputDecoration(
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<UsersRecord>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final buttonchangemailUsersRecord = snapshot.data!;
                        return FFButtonWidget(
                          onPressed: () async {
                            ...
                            final user = await authManager.signInWithEmail(
                              context,
                              _model.currentemailController.text,
                              _model.currentpwController.text,
                            );
                            if (user == null) {
                              return;
                            }
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Successfuly change e-mail!'),
                                  content: Text(
                                      'You will be automatically log-out. Please sign in again.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
